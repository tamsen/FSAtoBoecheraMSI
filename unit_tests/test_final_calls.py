...
class TestFinalCalls(unittest.TestCase):
    ...
    def test_stutter_check_onBF20(self):
     ...
     [216.5, 960.4], [218.5, 2679.9]]
        ...
        results = peak_analysis.stutter_fix(BF20_raw_peaks, merge_peaks_closer_than_this,
    ...
    def test_stutter_check_2(self):
        ...
        results = peak_analysis.stutter_fix(peaks, merge_peaks_closer_than_this,
                                            peak_analysis.take_run_maximum)
    ...
    def test_PS1_BF20_final_calls(self):
        ...
        self.assertEqual([208,214,219], final_alleles_called) #close enough. would be better if 214 was 218
    ...
    def test_PS2_C8_final_calls(self):
        ...
        self.assertEqual(3, len(filtered_alleles_called))
        self.assertEqual(3, len(filtered_alleles_called))
        self.assertEqual([232,242,253], final_alleles_called)
